-- ============================================================
-- BACKUP — live definitions captured immediately before Part B2
-- (PO grouping/combining patch to sp_nt_ApproveSupplierQuotation)
-- Captured: 2026-08-14T04:03:02.776Z
-- Restore: run this whole file with node sql/run_sql.mjs to put the
-- exact pre-B2 behavior back (CREATE OR ALTER, safe to re-run).
-- ============================================================

-- ── sp_nt_ApproveSupplierQuotation (as of 2026-07-28T14:00:42.243Z) ──
