...
-- ============================================================
-- sp_nt_GetPrLinesForPoGrouping — preview how a PR's lines will group into
-- POs, by (vendor, line_type), for the buyer's grouping-preview screen (B4).
-- Vendor is only known for a product line once a quotation has been
-- selected, or for a service line once a Service PO names one — lines
-- without a resolvable vendor yet show vendor_sno=NULL (still ungrouped).
...
--   SELECT modify_date FROM sys.objects WHERE name = 'sp_nt_ApproveSupplierQuotation';
--   SELECT name FROM sys.procedures WHERE name = 'sp_nt_GetPrLinesForPoGrouping';
-- To roll back sp_nt_ApproveSupplierQuotation specifically, run:
--   node sql/run_sql.mjs sql/backups/pre_B2_2026-08-14T04-03-02-773Z.sql
-- ============================================================
